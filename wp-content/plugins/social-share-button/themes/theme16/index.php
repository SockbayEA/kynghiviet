	...
	foreach($social_share_button_sites as $site_key=>$site_info ){
		...
		if(isset($site_info['visible'])){
			...
			if($i<$social_share_button_total){
				...
				$html_button.= '<span class="button-name">Share on '.$site_info['title'].'</span>';
				...
				// $html_button.= '</a>';
					...
					$html_popup_buttons.= '<span class="button-icon"><i class="fa fa-'.$site_info['icon'].'"></i></span>';			
					$html_popup_buttons.= '<span class="button-name">Share on '.$site_info['title'].'</span>';			
